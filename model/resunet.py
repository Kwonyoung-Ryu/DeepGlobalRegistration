...
from submodule.DeepGlobalRegistration.model.common import get_norm

from submodule.DeepGlobalRegistration.model.residual_block import conv, conv_tr, get_block
